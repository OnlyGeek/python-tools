...
EMAIL_USER = '441743247@qq.com'
EMAIL_PASSWORD = 'fkzutwxdjukucbbh'
RECIPIENTS = ['13990858371@163.com']
...
def main():
    ...
    data = collect_momintor_data()
    data.update(dict(hostname=hostname))
    

    content = render("jkxx.html",**data)

    with yagmail.SMTP(user=EMAIL_USER, password=EMAIL_PASSWORD, host='smtp.qq.com') as yag:
        for recipient in RECIPIENTS:
            yag.send(recipient, "jkxx", content)
